          ...
          <section class='col-xs-12 col-sm-6 col-md-6'>
            <section>
              <h2>Deploying code changes</h2>
                <p>OpenShift uses the <a href="http://git-scm.com/">Git version control system</a> for your source code, and grants you access to it via the Secure Shell (SSH) protocol. In order to upload and download code to your application you need to give us your <a href="https://www.openshift.com/developers/remote-access">public SSH key</a>. You can <a href="https://openshift.redhat.com/app/console/keys/new">upload it within the web console</a> or install the <a href="https://www.openshift.com/developers/rhc-client-tools-install">RHC command line tool</a> and run <code>rhc setup</code> to generate and upload your key automatically.</p>
                ...
                <p>If you created the application from the web console, you'll need to manually clone the repository to your local system. Copy the Git URL located on the <a href="https://openshift.redhat.com/app/console">application page</a>, and then run:</p>
...
$ git push</pre>
          ...
          <section class="col-xs-12 col-sm-6 col-md-6">
                ...
                <h3>Web Console</h3>
                <p>You can use the <a href="https://openshift.redhat.com/app/console">OpenShift Online web console</a> to enable additional capabilities via cartridges, add collaborator access authorizations, designate custom domain aliases, and manage domain memberships.</p>
