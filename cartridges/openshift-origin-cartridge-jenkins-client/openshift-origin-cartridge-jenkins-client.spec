...
* Wed Dec 18 2013 Adam Miller <admiller@redhat.com> 1.17.2-1
- <jenkins_create_job> Remove always-failing test, capture jenkins createItem
  HTTP response (jolamb@redhat.com)
