...
then
    ...
    then
        ...
        if [ ! -h ${OPENSHIFT_REPO_DIR}"/deployments && ! -h ${OPENSHIFT_HOMEDIR}"/jbossas-7/jbossas-7/standalone/deployments ]
        then
        	cp -rf "${OPENSHIFT_REPO_DIR}"/deployments/* "${OPENSHIFT_HOMEDIR}"/jbossas-7/jbossas-7/standalone/deployments
        fi
