...
%changelog
* Wed Mar 27 2013 Dan McPherson <dmcphers@redhat.com> 0.0.6-1
- Automatic commit of package [openshift-origin-cartridge-mysql] release
  [0.0.5-1]. (dmcphers@redhat.com)
