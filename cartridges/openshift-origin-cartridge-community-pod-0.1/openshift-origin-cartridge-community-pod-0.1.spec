%global cartridgedir %{_libexecdir}/openshift/cartridges/community-pod-0.1
...
Requires:      httpd
Obsoletes:     cartridge-community-pod-0.1

%description
Provides support for installing/using community cartridges on OpenShift
