...
class CloudUser
  ...
  def add_capability_inherit_on_subaccounts(capability)
    ...
    unless inherit_caps.include?(capability)
      _capabilities["inherit_on_subaccounts"] = inherit_caps + [capability]
    end
  end
  ...
  def add_gear_size(gear_size)
    ...
    unless capabilities['gear_sizes'].include?(gear_size)
      _capabilities['gear_sizes'] = capabilities['gear_sizes'] + [gear_size]
      self.save!
    end
    domains.each do |d|
  ...
  def remove_gear_size(gear_size)
    ...
    _capabilities["gear_sizes"] = caps["gear_sizes"] - [gear_size]
    self.save!
    domains.each do |d|
