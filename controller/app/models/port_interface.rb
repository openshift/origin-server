...
class PortInterface
  ...
  def self.create_port_interface(gear, component_id, endpoint_hash)
    ...
    PortInterface.new(cartridge_name: comp.cartridge_name, external_port: public_port.to_s, external_address: public_ip, internal_port: internal_port.to_s, internal_address: internal_ip, protocols: protocols, type: types)
  end
