...
Feature: 10gen-mms-agent Embedded Cartridge
  ...
  Scenario: 10gen-mms-agent Embedded Cartridge
    ...
    And the embedded redhat-10gen-mms-agent cartridge subdirectory named mms-agent will exist
    And the embedded redhat-10gen-mms-agent cartridge log files will exist
    ...
    Then 0 processes named python will be running
    And the embedded redhat-10gen-mms-agent cartridge subdirectory named mms-agent will not exist
    And the embedded redhat-10gen-mms-agent cartridge log files will not exist
