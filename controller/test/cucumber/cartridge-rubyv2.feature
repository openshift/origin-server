...
Feature: V2 SDK Ruby Cartridge
  ...
  And the ruby cartridge private endpoints will be exposed
  And the ruby RUBY_DIR env entry will exist
  And the ruby RUBY_LOG_DIR env entry will exist
  And the ruby RUBY_VERSION env entry will exist
