...
Then /^the python cartridge private endpoints will be exposed$/ do
  app_env_var_will_exist('PYTHON_IP')
  app_env_var_will_exist('PYTHON_PORT')
end

Then /^the python-plugin cartridge private endpoints will be exposed$/ do
  app_env_var_will_exist('PYTHON_PLUGIN_EXAMPLE_IP1')
  app_env_var_will_exist('PYTHON_PLUGIN_EXAMPLE_PORT1')
end

Then /^the python-plugin cartridge private endpoints will be concealed$/ do
  app_env_var_will_not_exist('PYTHON_PLUGIN_EXAMPLE_IP1')
  app_env_var_will_not_exist('PYTHON_PLUGIN_EXAMPLE_PORT1')
end
