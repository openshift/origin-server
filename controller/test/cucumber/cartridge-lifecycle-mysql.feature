...
Feature: MySQL Tests
  ...
  Scenario: Snapshot/Restore an application with a MySQL 5.5 database
    Given a new client created mock-0.1 application
    Given the embedded mysql-5.5 cartridge is added
    When I create a test table in mysql
    When I insert test data into mysql
    Then the test data will be present in mysql
  ...
  Scenario: Snapshot/Restore a scalable application with a MySQL 5.1 database
  ...
  Scenario: Snapshot/Restore a scalable application with a MySQL 5.5 database
    Given a new client created scalable mock-0.1 application
    Given the embedded mysql-5.5 cartridge is added
    When I create a test table in mysql
    When I insert test data into mysql
    ...
    When the embedded mysql-5.5 cartridge is removed
    And the embedded mysql-5.5 cartridge is added
    Then I can select from mysql
  ...
  Scenario: Snapshot/Restore between applications with a MySQL 5.1 database
    Given a new client created mock-0.1 application
    Given the embedded mysql-5.1 cartridge is added
  ...
  Scenario: Snapshot/Restore between applications with a MySQL 5.5 database
    Given a new client created mock-0.1 application
    Given the embedded mysql-5.5 cartridge is added
    When I create a test database in mysql
