    ...
    class Openshift<RPC::Agent
      ...
      def upgrade_action
        ...
        begin
          ...
          upgrader = OpenShift::Runtime::Upgrader.new(uuid, application_uuid, auth_token, auth_iv, namespace, version, hostname, ignore_cartridge_version, scalable, OpenShift::Runtime::Utils::Hourglass.new(235))
        rescue Exception => e
          report_exception e
          exitcode = 1
