...
spec_file = "rubygem-openshift-origin-frontend-nodejs-websocket.spec"

Gem::Specification.new do |s|
  s.name        = "openshift-origin-frontend-nodejs-websocket"
  ...
  s.rubyforge_project = "openshift-origin-frontend-nodejs-websocket"

  s.files       = Dir[lib_dir] + Dir[conf_dir] + Dir[config_dir]
  s.test_files  = Dir[test_dir]
  s.executables   = Dir[bin_dir]
  s.files       += %w(README.md Rakefile Gemfile rubygem-openshift-origin-frontend-nodejs-websocket.spec openshift-origin-frontend-nodejs-websocket.gemspec LICENSE COPYRIGHT)
  s.require_paths = ["lib"]
