...
spec_file = "rubygem-openshift-origin-frontend-apachedb.spec"

Gem::Specification.new do |s|
  s.name        = "openshift-origin-frontend-apachedb"
  ...
  s.rubyforge_project = "openshift-origin-frontend-apachedb"

  s.files       = Dir[lib_dir] + Dir[conf_dir] + Dir[config_dir]
  s.test_files  = Dir[test_dir]
  s.executables   = Dir[bin_dir]
  s.files       += %w(README.md Rakefile Gemfile rubygem-openshift-origin-frontend-apachedb.spec openshift-origin-frontend-apachedb.gemspec LICENSE COPYRIGHT)
  s.require_paths = ["lib"]
