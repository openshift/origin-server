...
spec_file = "rubygem-openshift-origin-frontend-apache-vhost.spec"

Gem::Specification.new do |s|
  s.name        = "openshift-origin-frontend-apache-vhost"
  ...
  s.rubyforge_project = "openshift-origin-frontend-apache-vhost"

  s.files       = Dir[lib_dir] + Dir[conf_dir] + Dir[config_dir]
  s.test_files  = Dir[test_dir]
  s.executables   = Dir[bin_dir]
  s.files       += %w(README.md Rakefile Gemfile rubygem-openshift-origin-frontend-apache-vhost.spec openshift-origin-frontend-apache-vhost.gemspec LICENSE COPYRIGHT)
  s.require_paths = ["lib"]
