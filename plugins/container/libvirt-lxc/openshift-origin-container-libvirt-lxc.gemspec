...
spec_file = "rubygem-openshift-origin-container-libvirt-lxc.spec"

Gem::Specification.new do |s|
  s.name        = "openshift-origin-container-libvirt-lxc"
  ...
  s.rubyforge_project = "openshift-origin-container-libvirt-lxc"

  s.files       = Dir[lib_dir] + Dir[conf_dir] + Dir[config_dir]
  s.test_files  = Dir[test_dir]
  s.executables = []
  s.files       += %w(README.md Rakefile Gemfile rubygem-openshift-origin-container-libvirt-lxc.spec openshift-origin-container-libvirt-lxc.gemspec LICENSE COPYRIGHT)
  s.require_paths = ["lib"]
