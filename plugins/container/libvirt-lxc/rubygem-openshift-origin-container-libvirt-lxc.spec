...
%global gem_name openshift-origin-container-libvirt-lxc
...
cp %{buildroot}/%{gem_instdir}/conf/openshift-origin-container-libvirt-lxc.conf.example %{buildroot}/etc/openshift/node-plugins.d/
...
%changelog
* Thu May 09 2013 Krishna Raman <kraman@gmail.com> 0.0.1-1
