...
spec_file = "rubygem-openshift-origin-container-selinux.spec"

Gem::Specification.new do |s|
  s.name        = "openshift-origin-container-selinux"
  ...
  s.rubyforge_project = "openshift-origin-container-selinux"

  s.files       = Dir[lib_dir] + Dir[conf_dir] + Dir[config_dir]
  s.test_files  = Dir[test_dir]
  s.executables   = Dir[bin_dir]
  s.files       += %w(README.md Rakefile Gemfile rubygem-openshift-origin-container-selinux.spec openshift-origin-container-selinux.gemspec LICENSE COPYRIGHT)
  s.require_paths = ["lib"]
