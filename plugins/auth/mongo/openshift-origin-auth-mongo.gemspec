...
spec_file = "openshift-origin-auth-mongo.spec"
...
Gem::Specification.new do |s|
  ...
  s.files       += %w(README.md Rakefile Gemfile openshift-origin-auth-mongo.spec openshift-origin-auth-mongo.gemspec LICENSE COPYRIGHT)
  s.require_paths = ["lib"]
