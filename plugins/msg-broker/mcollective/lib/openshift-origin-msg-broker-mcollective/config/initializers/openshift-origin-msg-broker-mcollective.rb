...
Broker::Application.configure do
  unless config.respond_to? :gearchanger
    ...
    config.msg_broker = {
      ...
      :districts => {
        :enabled => conf.get_bool("DISTRICTS_ENABLED") || defaults.get("DISTRICTS_ENABLED"),
        :require_for_app_create => conf.get_bool("DISTRICTS_REQUIRE_FOR_APP_CREATE") || defaults.get("DISTRICTS_REQUIRE_FOR_APP_CREATE"),
