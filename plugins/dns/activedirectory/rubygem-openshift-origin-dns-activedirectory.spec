...
%global gem_name openshift-origin-dns-activedirectory
...
%description
Provides a DNS service update plugin using Active Directory
...
cp %{buildroot}/%{gem_dir}/gems/%{gem_name}-%{version}/conf/openshift-origin-dns-activedirectory.conf.example %{buildroot}/etc/openshift/plugins.d/openshift-origin-dns-activedirectory.conf.example
...
%{gem_spec}
%{gem_cache}
/etc/openshift/plugins.d/openshift-origin-dns-activedirectory.conf.example
