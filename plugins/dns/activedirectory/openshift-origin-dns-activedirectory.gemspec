...
spec_file = "rubygem-openshift-origin-dns-activedirectory.spec"

Gem::Specification.new do |s|
  s.name        = "openshift-origin-dns-activedirectory"
  ...
  s.rubyforge_project = "openshift-origin-dns-activedirectory"

  s.files       = Dir[lib_dir] + Dir[doc_dir] + Dir[conf_dir] + Dir[config_dir]
  s.test_files  = Dir[test_dir]
  s.executables   = Dir[bin_dir]
  s.files       += %w(README.md Rakefile Gemfile rubygem-openshift-origin-dns-activedirectory.spec openshift-origin-dns-activedirectory.gemspec LICENSE COPYRIGHT)
  s.require_paths = ["lib"]
