...
%global gem_name openshift-origin-dns-gss-tsig
...
cp %{buildroot}/%{gem_dir}/gems/%{gem_name}-%{version}/conf/openshift-origin-dns-gss-tsig.conf.example %{buildroot}/etc/openshift/plugins.d/openshift-origin-dns-gss-tsig.conf.example
...
%{gem_spec}
%{gem_cache}
/etc/openshift/plugins.d/openshift-origin-dns-gss-tsig.conf.example
