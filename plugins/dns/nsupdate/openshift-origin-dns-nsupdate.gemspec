...
spec_file = "rubygem-openshift-origin-dns-nsupdate.spec"
...
Gem::Specification.new do |s|
  ...
  s.summary     = 'OpenShift Origin DNS NSUpdate plugin'

  s.files       = Dir[lib_dir] + Dir[doc_dir] + Dir[conf_dir] + Dir[config_dir]
  s.test_files  = Dir[test_dir]
  s.executables   = Dir[bin_dir]
  s.files       += %w(README.md Rakefile Gemfile rubygem-openshift-origin-dns-nsupdate.spec openshift-origin-dns-nsupdate.gemspec LICENSE COPYRIGHT)
  s.require_paths = ["lib"]
