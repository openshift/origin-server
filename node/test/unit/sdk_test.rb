...
module OpenShift
  class SdkTest < OpenShift::NodeTestCase
    def test_translate_shell_ex_for_client
      orig = OpenShift::Runtime::Utils::ShellExecutionException.new("Message", 1, "stdout", "stderr")
      orig.set_backtrace(["line1", "line2"])

      translated = OpenShift::Runtime::Utils::Sdk.translate_shell_ex_for_client(orig)

      assert_kind_of OpenShift::Runtime::Utils::ShellExecutionException, translated
      assert_equal orig.message, translated.message
      assert_equal orig.rc, translated.rc
      assert_equal OpenShift::Runtime::Utils::Sdk.translate_out_for_client(orig.stdout, :message), translated.stdout
      assert_equal OpenShift::Runtime::Utils::Sdk.translate_out_for_client(orig.stderr, :error), translated.stderr
    ...
    def test_translate_shell_ex_for_client_rc_override
      ...
      translated = OpenShift::Runtime::Utils::Sdk.translate_shell_ex_for_client(orig, 2)
    ...
    def test_translate_out_for_client_message
      ...
      translated = OpenShift::Runtime::Utils::Sdk.translate_out_for_client(out, :message)
    ...
    def test_translate_out_for_client_error
      ...
      translated = OpenShift::Runtime::Utils::Sdk.translate_out_for_client(out, :error)
    ...
    def test_translate_out_for_client_nil
      translated = OpenShift::Runtime::Utils::Sdk.translate_out_for_client(nil, :message)
