...
require 'openshift-origin-node/utils/migrate_progress'
...
module OpenShiftMigration
  ...
  #
  # This method implements the version-to-version migration for cartridges.
  #
  # Note: The migration method must be reentrant, meaning it should be able to
  ...
  #
  # Migrate a cartridge from a compatible prior version:
  #
  ...
  #
  # Migrate a cartridge from an incompatible prior version:
  #
  ...
  #
  # Inspect the pre-migration state of the gear and make a copy for use later
  # in the migration.
  #
  ...
  #
  # Validate the gear after migration, if the premigration state was not 'stopped'
  ...
  #
  # Cleanup the migration metadata on the gear if the validation step has been
  # run successfully.
  #
