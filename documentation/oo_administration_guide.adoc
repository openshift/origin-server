...
JBoss cartridges are distributed with OpenShift, however they will not work without a JRE to run against.
The JBoss and WildFly JREs are not currently available as RPMs, so unfortunately we cannot include them
