...
* https://www.openshift.com/blogs/announcing-the-release-of-openshift-origin-v4[OpenShift M4 Release Info]
...
a|link:oo_m4_release_notes.html[Origin M4 Release Notes] +
link:oo_administration_guide.html[Administration Guide] +
