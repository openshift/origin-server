...
=== Origin 3.0 Documentation
This documentation set is for version 3.0. If you are looking for the "bleeding edge" upstream documentation, see http://openshift.github.io/documentation-latest/
...
a|link:oo_contributors_guide.html[Origin Contributors Guide] +
...
OpenShift Origin sources are arranged into 3 repositories:
