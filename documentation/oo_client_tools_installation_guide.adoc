...
== Ubuntu
These instructions are broken out by Ubuntu version.footnote:[Hat tip to http://www.w3bootstrap.com/install-openshift-client-tools-ubuntu-14-04/[this article] for the updated instructions for Ubuntu 14.04.]
