...
Given /^a settings.py file exists$/ do
  ...
  system("mkdir -p /var/lib/stickshift/#{acct_name}/app-root/repo/.openshift/mms > /dev/null")
  system("cp /usr/local/share/mms-agent/settings.py /var/lib/stickshift/#{acct_name}/app-root/repo/.openshift/mms/settings.py > /dev/null")
  system("chown -R #{acct_name}:#{acct_name} /var/lib/stickshift/#{acct_name}/app-root/repo/.openshift/mms/")

  filepath = "/var/lib/stickshift/#{acct_name}/app-root/repo/.openshift/mms/settings.py"
